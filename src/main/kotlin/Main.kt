 ...
 */
const val NUM_COLUMNS: Int = 512

/**
 * Number of rows in the maze (height)
 */
const val NUM_ROWS: Int = 288
 ...
 */
const val WALL_WIDTH: Double = 1.0
 ...
 */
const val PATH_WIDTH: Double = 1.0
...
const val HALF_WALL_WIDTH = WALL_WIDTH / 2.0
...
fun main() {
	application {
		...
		program {
			...
			println("""
				===================================================================================
				| Please run this with a stack size of at least 32MB to prevent a stack overflow, |
				| i.e. use JVM option -Xss32M                                                     |
				===================================================================================
				""".trimIndent()
			)
